...
/* amount that aligned STUFFs are to be horizontally scaled to avoid overlap */
#define MINHORZSCALE	(2.0 / 3.0)
 ...
 * already used.  The other three values throw the key signature away and use
 * accidentals to indicate the correct notes.  They differ only in whether to
 * use extra (technically redundant) accidentals.
 */
